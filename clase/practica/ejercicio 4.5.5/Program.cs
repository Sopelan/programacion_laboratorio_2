...
/* Ampliar la base de datos de ficheros (ejemplo 46) para que incluya una opción de búsqueda parcial, en la que el usuario indique parte del nombre y se muestre todos los ficheros que contienen ese fragmento 
 * (usando "Contains" o "IndexOf"). Esta búsqueda no debe distinguir mayúsculas y minúsculas (con la ayuda de ToUpper o ToLower).*/
namespace ejercicio_4._5._5
{
    class Program
    {
        struct TipoFicha
            ...
            {       /* Menu principal */
                ...
                switch (opcion)
                {
                    ...
                    case 5:
                        ...
                        for (i = 0; i < numeroFichas; i++)
                            if (fichas[i].nombreFich.ToLower().Contains(contiene.ToLower()))
                                Console.WriteLine("Nombre: {0}; Tamaño: {1} KB", fichas[i].nombreFich, fichas[i].tamanyo);
                        break;
