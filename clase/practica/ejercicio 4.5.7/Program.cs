...
/* Ampliar la base de datos de ficheros (ejemplo 46) para que se pueda borrar un cierto dato (habrá que "mover hacia atrás" todos los datos que había después de ese, y disminuir el contador de la cantidad de datos 
 * que tenemos).*/ 
namespace ejercicio_4._5._7
{
    class Program
    {
        struct TipoFicha
