...
/*  Ampliar el ejercicio anterior (4.5.5) para que la búsqueda sea incremental: el usuario irá indicando letra a letra el texto que quiere buscar, y se mostrará todos los datos que lo contienen (por ejemplo, 
 *  primero los que contienen "j", luego "ju", después "jua" y finalmente "juan").*/
namespace ejercicio_4._5._6
{
    class Program
    {
        struct TipoFicha
