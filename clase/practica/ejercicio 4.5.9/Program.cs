...
/*  Ampliar la base de datos de ficheros (ejemplo 46) para que se permita ordenar los datos por nombre. Para ello, deberás buscar información sobre algún método de ordenación sencillo, como el "método de burbuja"
 *  (en el siguiente apartado tienes algunos), y aplicarlo a este caso concreto.*/
namespace ejercicio_4._5._9
{
    class Program
    {
        struct TipoFicha
